...
namespace Osepaishvili_Halyk_Task.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = Osepaishvili_Halyk_TaskConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(Osepaishvili_Halyk_TaskDbContext context)
        {
            _context = context;
        }
